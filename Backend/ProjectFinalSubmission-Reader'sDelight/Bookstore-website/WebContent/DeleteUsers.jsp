...
<tr><th></th>
<th>PIC</th><th>NAME</th><th>GENDER</th><th>ADDR1</th><th>ADDR2</th><th>MOBILE</th><th>EMAIL</th><th>UNAME</th><th>PASSWORD</th></tr>
<% 
while(rs.next())
{
	out.println("<tr>");
	out.println("<td><input type='checkbox' name='user' value='"+rs.getString(7)+"' /></td>");
...
out.println("<center><input type='submit' value='Delete Users' /></center>");
out.println("</form>");
%>
