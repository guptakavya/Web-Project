...
<style>
#k{float:right;background-color:black;}
table
{
...
<tr><th></th><th>Cart ID</th>
<th>UNAME</th><th>BOOKID</th><th>TITLE</th><th>DATE</th><th>PRICE</th><th>QUANTITY</th><th>BOUGHT</th></tr>
<% 
while(rs.next())
{
	out.println("<tr>");
	out.println("<td><input type='radio' name='user' value='"+rs.getString(8)+"' /></td>");
...
out.println("<center><input type='submit' value='Select Reservation' /></center>");
out.println("</form>");
%>
	<h3><a id=k href="AdminHome.jsp">HOME</a></h3>
	</div>
